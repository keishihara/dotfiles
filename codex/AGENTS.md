...
- Pull request titles must follow Conventional Commits format: `type(scope): summary`. Infer the type and scope directly when clear; inspect repository-specific conventions only when ambiguous.
